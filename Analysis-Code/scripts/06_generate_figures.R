# Generate figures for main text of:
# National Technology Diffusion in Countries
# Greene, Brutschin, Gidden, Nemet
# Code written by: Jenna Greene

# If running outside of initializer, set wd
# root_folder <- setwd('ROOT_FOLDER_HERE')
...
descriptive_HATCH_histograms <- ggarrange(hist, hist_2, 
                                          labels = c("a", "b"), 
                                          ncol =2, nrow = 1)
ggsave("fig1_descriptive_histograms.png", 
       descriptive_HATCH_histograms, width = 11, height = 6, units = "in", dpi = 300)
ggsave("fig1_descriptive_histograms.pdf", 
       descriptive_HATCH_histograms, width = 11, height = 6, units = "in", dpi = 300)
...
ggsave("fig2_legend_plot.png", legend_plot, width = 12.5, height = 4, dpi = 300)
ggsave("fig2_legend_plot.pdf", legend_plot, width = 12.5, height = 4, dpi = 300)
...
ggsave(file.path("fig2_Combined_Scatterplots.png"), grid_arrange_plots,
       width = 14, height = 14, dpi = 300)

ggsave(file.path("fig2_Combined_Scatterplots.pdf"), grid_arrange_plots,
       width = 14, height = 14, dpi = 300)
### ---------------------- Figure 3  -------------------
...
describe_categorical_tech(data = hatch_growth_filter, 
                          ...
                          save_filename = "fig3_complexity.pdf")
...
describe_categorical_tech(data = hatch_growth_filter, 
                          ...
                          save_filename = "fig3_adopt_boxplot.pdf")
...
describe_categorical_tech(data = hatch_growth_filter,
                          ...
                          save_filename = 'fig3_replaceent_boxplot.pdf')
...
describe_categorical_tech(data = hatch_growth_filter,
                          ...
                          save_filename = 'fig3_feedstock_boxplot.pdf')
...
ggsave("fig4_combined_correlations.png", combined_correlations, width = 12, height = 12, units = "in", dpi = 300)
ggsave("fig4_combined_correlations.pdf", combined_correlations, width = 12, height = 12, units = "in", dpi = 300)
...
ggsave("fig5_multivariate_coefficient_estimates_plot.png", plot = coeff_plot, width = 12, height = 10, dpi = 300)
ggsave("fig5_multivariate_coefficient_estimates_plot.pdf", plot = coeff_plot, width = 12, height = 10, dpi = 300)
